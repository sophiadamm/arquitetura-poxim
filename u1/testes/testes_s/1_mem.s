...
main:
    ...
    # stores: modify memory (usar t6 e s0 em vez de t7)
    li      t6, 0xAA
    sb      t6, 12(t0)       # store byte at my_data+12
    li      s0, 0xBBBB
    sh      s0, 13(t0)       # store half
    li      s1, 0xDEADBEEF
